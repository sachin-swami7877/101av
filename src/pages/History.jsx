...
import { gameAPI, spinnerAPI } from '../services/api';
...
const History = () => {
  ...
  const [fetched, setFetched] = useState({ aviator: false, spinner: false });
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'cancelled': return 'bg-[#EDE9FE] text-gray-600';
