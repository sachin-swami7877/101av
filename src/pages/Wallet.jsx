    ...
    <div className="min-h-screen bg-[#f3f5f7] pb-20 overflow-x-hidden">
      ...
      <Dialog open={tcOpen} onClose={() => setTcOpen(false)} maxWidth="sm" fullWidth>
        <div className="flex items-center justify-between px-6 pt-5 pb-2">
          ...
          <button type="button" onClick={() => setTcOpen(false)} className="w-8 h-8 rounded-full hover:bg-[#EDE9FE] flex items-center justify-center transition-colors">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-5">
            ...
            <div className="flex gap-2">
              <button onClick={() => setCancelConfirm(null)} className="flex-1 bg-[#EDE9FE] text-gray-700 py-2.5 rounded-lg font-medium text-sm">
                Go Back
              </button>
